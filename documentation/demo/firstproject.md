...
| Ping-able            	| Windows Host (Cloud) :white_check_mark:     	| Router (R1) :white_check_mark:              	| VirtualPC (PC1) :white_check_mark:          	|
|----------------------	|---------------------------	|---------------------------	|---------------------------	|
| Windows Host (Cloud) :white_check_mark:	| 10.1.1.100 --> 10.1.1.100 	| 10.1.1.100 --> 10.1.1.120 	| 10.1.1.100 --> 10.1.1.130 	|
| Router (R1)          :white_check_mark:	| 10.1.1.120 --> 10.1.1.100 	| 10.1.1.120 --> 10.1.1.120 	| 10.1.1.120 --> 10.1.1.130 	|
| VirtualPC (PC1)      :white_check_mark:	| 10.1.1.130 --> 10.1.1.100 	| 10.1.1.130 --> 10.1.1.120 	| 10.1.1.130 --> 10.1.1.130 	|
